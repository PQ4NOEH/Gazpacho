...
describe("SessionSummaryItem", () => {
    ...
    it("Should render", () => {
        render(<SessionSummaryItem item={sessionItem} onAddShift={jest.fn()} onViewDetail={jest.fn()} />);
        expect(screen.getByRole("listitem")).toBeInTheDocument();
        expect(screen.getByText(sessionItem.clientName)).toBeInTheDocument();
        expect(screen.getByRole("button", { name: "view session detail" })).toBeInTheDocument();
    ...
    it("Should trigger view detail", () => {
        ...
        render(<SessionSummaryItem item={sessionItem} onAddShift={jest.fn()} onViewDetail={handleViewDetail} />);
        fireEvent.click(screen.getByRole("button", { name: "view session detail" }));
    ...
    it("Should trigger add shift", () => {
        ...
        render(<SessionSummaryItem item={sessionItem} onAddShift={handleAddShift} onViewDetail={jest.fn()} />);
